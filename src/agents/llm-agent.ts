...
//    "- vimdiff(left,right[,cwd]): open an interactive vimdiff for human review. Returns {exitCode} when the user quits.",
    ...
    "",
    "MESSAGING",
    "- 🧍‍♂️user to talk to the human.",
    "- 🧍‍♂️<agent> to DM a peer.",
    "-  🧍‍♂️group to address everyone.",
    ...
    "- Avoid loops: do not repeat the same failing action; change approach or ask 🧍‍♂️user.",
    ...
    "COMPLETION",
    '- Upon completion of your tasks PLEASE TAG the user (🧍‍♂️user). If you do not the conversation will simply continue.',
  ].join("\n");
}
